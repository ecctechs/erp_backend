  ...
  static async addQuotationSale(req, res) {
    try {
      ...
      const insert_Quo = await Quotation_sale.create({
        ...
        remark_infernal: req.body.remark_infernal,
    ...
    try {
      ...
      for (let log of quotationslist) {
        ...
        result.push({
          ...
          customer_purchase: log.customer.customer_purchase,
          ...
          remark: log.remark,
          remark_infernal: log.remark_infernal,
    ...
    try {
      ...
      log.forEach((sale) => {
        const saleData = {
          ...
          customer_purchase: sale.customer_purchase,
