...
Route.get(RouteName+'/getPayment', verifyTokenWithRole(['superuser','manager','employee']),EmployeeController.getPayment)
Route.get(RouteName+'/getEmployeeSalary', verifyTokenWithRole(['superuser','manager','employee']),EmployeeController.getEmployeeSalary)
