...
const { uploadAndExtractZip , deleteAllData } = require('../controllers/uploadController');
...
Route.post(RouteName + '/importcsv', upload.single('csvFile') , MigrateController.importCsv);

// API Endpoint สำหรับอัปโหลดไฟล์ zip
Route.post(RouteName + '/import-all-csv', upload.single('zipFile'), async (req, res) => {
